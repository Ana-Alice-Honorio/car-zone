    ...
    <main className="flex min-h-screen flex-col bg-lightgray">
       <header className="p-6 flex h-20 items-center bg-gray shadow-lg justify-between">
        ...
        <div>
          <Link
            href="/login"
            className="flex items-end self-end rounded-lg bg-white px-6 py-2 transition-colors hover:bg-lightgray"
          >
            <span className="text-sm font-medium text-black ">Log in</span>
          </Link>
        </div>
      </header>
    </main>
